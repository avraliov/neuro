...
generic
   ...
   with package Net_Pack is new Net (Value_Type        => Value_Type,
                                     Abstract_Lay_Pack => Abstract_Lay_Pack,
                                     Lay_Pack          => Lay_Pack);
package Trainer is
   type Loss_Type is (MSE, CE);
   type LR_Type is delta 0.001 range 0.0 .. 1.0;
   ...
   type Parameters is record
      Learn_Rate : Value_Type;--replace type with LR_Type
      Loss       : Loss_Type;
      Epochs     : Positive;
   ...
   function Train (This   : in out Net_Pack.Net; Input : Input_Dataset; Target : Target_Dataset;
   ...
   function Test (This : in out Net_Pack.Net; Input : Input_Dataset) return Target_Dataset with
     Pre => Input'Length > 1,
